...
void special_move(papan *board[10][10], stack *history, stack *termakan, int *poin_putih, int *poin_hitam, list *list_ada_putih, list *list_ada_hitam, queue *giliran, int turn){
    ...
    // if(cek_castling_pendek(board, *history, *list_ada_putih, *list_ada_hitam, giliran)) // masih salah, ga kompatibel yg gw gapake pointer - palkon
    // {
    //     printf("2. Castling Pendek");
    // }

    // if(cek_castling_panjang(board, *history, *list_ada_putih, *list_ada_hitam, giliran))
    // {
